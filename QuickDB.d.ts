...
import { DBConfigBaseProps, QuickDBMap, InitOptionsProps, ModelFile, QuickConfigOptions } from "./type";
export declare class QuickDB {
    ...
    getName(): string;
    quickDefine(tableName: string, fields: string[], options?: QuickConfigOptions): Model;
